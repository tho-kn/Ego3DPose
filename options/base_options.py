...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--num_rot_heatmap', type=int, default=0,
                                help='# of heatmaps')
        self.parser.add_argument('--use_limb_heatmap', action='store_true',
                                 help='If true, use raw limb heatmap')
        self.parser.add_argument('--heatmap_type', type=str, default='none',
                                 help='Choose type of limb heatmap, [none] | [sin] | [angle] | [depth]')
